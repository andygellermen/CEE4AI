...
func DefaultTableSpecs() []TableSpec {
	return []TableSpec{
		...
		{TableName: "review.review_flags", RelativePath: "review/review_flags.csv", ConflictColumns: []string{"id"}, ResetSequence: true},
		{TableName: "governance.content_policies", RelativePath: "governance/content_policies.csv", ConflictColumns: []string{"id"}, ResetSequence: true},
		{TableName: "governance.sensitivity_rules", RelativePath: "governance/sensitivity_rules.csv", ConflictColumns: []string{"id"}, ResetSequence: true},
		{TableName: "governance.ruleset_versions", RelativePath: "governance/ruleset_versions.csv", ConflictColumns: []string{"id"}, ResetSequence: true},
